	...
	namespace core {
		namespace prog {
			...
			void									Program_0001_0000_0000_0000::initVkPipeline(VkRenderPass& renderpass, uint32_t subpass) 
			{
				...
				F3D_ASSERT(createSpvShader("0001_0000_0000_0000.vert.spv", &vert_shader) != false, "Program_0001_0000_0000_0000 vertex shader");
				...
				F3D_ASSERT(createSpvShader("0001_0000_0000_0000.frag.spv", &frag_shader) != false, "Program_0001_0000_0000_0000 fragment shader");
