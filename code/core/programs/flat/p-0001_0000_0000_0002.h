...
namespace f3d {
	namespace core {
		namespace prog {
			class F3D_API Program_0001_0000_0000_0002 :
				public f3d::core::Program,
				protected f3d::core::DescriptorContainer {
			public:
				Program_0001_0000_0000_0002(std::shared_ptr< f3d::core::PhysicalDevice >& phys, std::shared_ptr< f3d::core::Device >& device);
