...
namespace f3d {
	namespace core {
		namespace prog {
			Program_0001_0001_0000_0000::Program_0001_0001_0000_0000(std::shared_ptr< f3d::core::PhysicalDevice >& phys, std::shared_ptr< f3d::core::Device >& device) : 
				Program::Program(device->vk_device, { F3D_COLOR_UNDEFINED, F3D_TEXTURE_UNDEFINED, F3D_LIGHT_DIRECTIONAL, F3D_SHADING_FLAT }),
