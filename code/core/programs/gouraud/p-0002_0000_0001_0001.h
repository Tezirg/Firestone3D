...
#ifndef _F3D_P_0002_0000_0001_0001_H
#define _F3D_P_0002_0000_0001_0001_H
...
namespace f3d {
	namespace core {
		namespace prog {
			class F3D_API Program_0002_0000_0001_0001 :
				public f3d::core::Program,
				protected f3d::core::DescriptorContainer {
			public:
				Program_0002_0000_0001_0001(std::shared_ptr< f3d::core::PhysicalDevice >& phys, std::shared_ptr< f3d::core::Device >& device);
				~Program_0002_0000_0001_0001();
