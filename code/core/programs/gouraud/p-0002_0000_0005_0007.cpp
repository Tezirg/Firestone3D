#include "p-0002_0000_0005_0007.h"

namespace f3d {
	namespace core {
		namespace prog {
			Program_0002_0000_0005_0007::Program_0002_0000_0005_0007(std::shared_ptr< f3d::core::PhysicalDevice >& phys, std::shared_ptr< f3d::core::Device >& device) : 
				Program::Program(device->vk_device, { F3D_COLOR_AMBIENT | F3D_COLOR_DIFFUSE | F3D_COLOR_SPECULAR, F3D_TEXTURE_DIFFUSE | F3D_TEXTURE_AMBIENT, F3D_LIGHT_UNDEFINED, F3D_SHADING_GOURAUD }),
				DescriptorContainer::DescriptorContainer(phys, device) {
			}

			Program_0002_0000_0005_0007::~Program_0002_0000_0005_0007() {
				std::cout << "Destructor: " << __FILE__ << std::endl;
			}

			void									Program_0002_0000_0005_0007::initVkPipeline(VkRenderPass& renderpass, uint32_t subpass) {
				VkResult							r;
				...
				F3D_ASSERT(createSpvShader("0002_0000_0005_0007.vert.spv", &vert_shader) != false, "0002_0000_0005_0007 vertex shader");
				...
				F3D_ASSERT(createSpvShader("0002_0000_0005_0007.frag.spv", &frag_shader) != false, "0002_0000_0005_0007 fragment shader");
			...
			void				Program_0002_0000_0005_0007::initVkPipelineInfos() {
			...
			void									Program_0002_0000_0005_0007::initVkLayout() 
			{
				VkResult							r;
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0002_0000_0005_0007 Create pipeline layout failed");
			}

			bool							Program_0002_0000_0005_0007::drawToCommandBuffer(VkCommandBuffer& cmd, f3d::tree::Mesh& mesh, f3d::tree::Scene& scene)
			{
