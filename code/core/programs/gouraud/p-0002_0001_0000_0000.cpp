#include "p-0002_0001_0000_0000.h"

namespace f3d {
	namespace core {
		namespace prog {
			Program_0002_0001_0000_0000::Program_0002_0001_0000_0000(std::shared_ptr< f3d::core::PhysicalDevice >& phys, std::shared_ptr< f3d::core::Device >& device) : 
				Program::Program(device->vk_device, { F3D_COLOR_UNDEFINED, F3D_TEXTURE_UNDEFINED, F3D_LIGHT_DIRECTIONAL, F3D_SHADING_GOURAUD }),
				DescriptorContainer::DescriptorContainer(phys, device) {
			}

			Program_0002_0001_0000_0000::~Program_0002_0001_0000_0000() {
				std::cout << "Destructor: " << __FILE__ << std::endl;
			}

			void									Program_0002_0001_0000_0000::initVkPipeline(VkRenderPass& renderpass, uint32_t subpass) 
			{
				VkResult							r;
				...
				F3D_ASSERT(createSpvShader("0002_0001_0000_0000.vert.spv", &vert_shader) != false, "Program_0002_0001_0000_0000 vertex shader");
				...
				F3D_ASSERT(createSpvShader("0002_0001_0000_0000.frag.spv", &frag_shader) != false, "Program_0002_0001_0000_0000 fragment shader");
			...
			void				Program_0002_0001_0000_0000::initVkPipelineInfos() {
			...
			void									Program_0002_0001_0000_0000::initVkLayout() 
			{
				VkResult							r;
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0002_0001_0000_0000 Create pipeline layout failed");
			}

			bool							Program_0002_0001_0000_0000::drawToCommandBuffer(VkCommandBuffer& cmd, f3d::tree::Mesh& mesh, f3d::tree::Scene& scene) 
			{
				...
				VkDescriptorSet				sets[3] = { sc.getWorldDescriptorSet(), m.getDescriptorSet(), sc.getLightsDescriptorSet()};
