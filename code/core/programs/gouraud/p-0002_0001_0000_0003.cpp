#include "p-0002_0001_0000_0003.h"

namespace f3d {
	namespace core {
		namespace prog {
			Program_0002_0001_0000_0003::Program_0002_0001_0000_0003(std::shared_ptr< f3d::core::PhysicalDevice >& phys, std::shared_ptr< f3d::core::Device >& device) : 
				Program::Program(device->vk_device, { F3D_COLOR_AMBIENT | F3D_COLOR_DIFFUSE, F3D_TEXTURE_UNDEFINED, F3D_LIGHT_DIRECTIONAL, F3D_SHADING_GOURAUD }),
				DescriptorContainer::DescriptorContainer(phys, device) {
			}

			Program_0002_0001_0000_0003::~Program_0002_0001_0000_0003() {
				std::cout << "Destructor: " << __FILE__ << std::endl;
			}

			void									Program_0002_0001_0000_0003::initVkPipeline(VkRenderPass& renderpass, uint32_t subpass) 
			{
				VkResult							r;
				...
				F3D_ASSERT(createSpvShader("0002_0001_0000_0003.vert.spv", &vert_shader) != false, "Program_0002_0001_0000_0003 vertex shader");
				...
				F3D_ASSERT(createSpvShader("0002_0001_0000_0003.frag.spv", &frag_shader) != false, "Program_0002_0001_0000_0003 fragment shader");
			...
			void				Program_0002_0001_0000_0003::initVkPipelineInfos() {
			...
			void									Program_0002_0001_0000_0003::initVkLayout() 
			{
				VkResult							r;
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0002_0001_0000_0003 Create pipeline layout failed");
			}

			bool							Program_0002_0001_0000_0003::drawToCommandBuffer(VkCommandBuffer& cmd, f3d::tree::Mesh& mesh, f3d::tree::Scene& scene) 
			{
