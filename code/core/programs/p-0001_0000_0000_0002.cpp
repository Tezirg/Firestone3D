...
namespace f3d {
	namespace core {
		namespace prog {
			Program_0001_0000_0000_0002::Program_0001_0000_0000_0002(VkDevice device) : Program::Program(device, 
				{ F3D_COLOR_DIFFUSE, F3D_TEXTURE_UNDEFINED, F3D_LIGHT_UNDEFINED, F3D_SHADING_FLAT }
			) {	}
