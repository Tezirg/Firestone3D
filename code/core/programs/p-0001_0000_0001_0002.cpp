#include "p-0001_0000_0001_0002.h"
...
namespace f3d {
	namespace core {
		namespace prog {
			...
			void									Program_0001_0000_0001_0002::initVkPipeline(VkRenderPass& renderpass, uint32_t subpass) {
				VkResult							r;
				...
				F3D_ASSERT(createSpvShader("0001_0000_0001_0002.vert.spv", &vert_shader) != false, "0001_0000_0001_0002 vertex shader");
				...
				F3D_ASSERT(createSpvShader("0001_0000_0001_0002.frag.spv", &frag_shader) != false, "0001_0000_0001_0002 fragment shader");
			...
			void				Program_0001_0000_0001_0002::initVkPipelineInfos() {
			...
			void									Program_0001_0000_0001_0002::initVkLayout() 
			{
				VkResult							r;
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0001_0000_0001_0002 Create descriptor set layout[0] failed");
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0001_0000_0001_0002 Create descriptor set layout[1] failed");
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0001_0000_0001_0002 Create descriptor set layout[2] failed");
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0001_0000_0001_0002 Create descriptor set layout[3] failed");
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0001_0000_0001_0002 Create pipeline layout failed");
			}

			bool							Program_0001_0000_0001_0002::drawToCommandBuffer(VkCommandBuffer& cmd, f3d::tree::Mesh& mesh, f3d::tree::Scene& scene)
			{
