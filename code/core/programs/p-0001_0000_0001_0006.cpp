#include "p-0001_0000_0001_0006.h"

namespace f3d {
	namespace core {
		namespace prog {
			Program_0001_0000_0001_0006::Program_0001_0000_0001_0006(std::shared_ptr< f3d::core::PhysicalDevice >& phys, std::shared_ptr< f3d::core::Device >& device) : 
				Program::Program(device->vk_device, { F3D_COLOR_DIFFUSE | F3D_COLOR_SPECULAR, F3D_TEXTURE_DIFFUSE, F3D_LIGHT_UNDEFINED, F3D_SHADING_FLAT }),
				DescriptorContainer::DescriptorContainer(phys, device) {
			}

			Program_0001_0000_0001_0006::~Program_0001_0000_0001_0006() {
				std::cout << "Destructor: " << __FILE__ << std::endl;
			}

			void									Program_0001_0000_0001_0006::initVkPipeline(VkRenderPass& renderpass, uint32_t subpass) {
				VkResult							r;
				...
				F3D_ASSERT(createSpvShader("0001_0000_0001_0006.vert.spv", &vert_shader) != false, "0001_0000_0001_0006 vertex shader");
				...
				F3D_ASSERT(createSpvShader("0001_0000_0001_0006.frag.spv", &frag_shader) != false, "0001_0000_0001_0006 fragment shader");
			...
			void				Program_0001_0000_0001_0006::initVkPipelineInfos() {
			...
			void									Program_0001_0000_0001_0006::initVkLayout() 
			{
				VkResult							r;
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0001_0000_0001_0006 Create descriptor set layout[0] failed");
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0001_0000_0001_0006 Create descriptor set layout[1] failed");
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0001_0000_0001_0006 Create descriptor set layout[2] failed");
				...
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0001_0000_0001_0006 Create descriptor set layout[3] failed");

				std::memset(&pipe_layout_info, 0, sizeof(VkPipelineLayoutCreateInfo));
				pipe_layout_info.sType = VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO;
				pipe_layout_info.pNext = NULL;
				pipe_layout_info.setLayoutCount = 4;
				pipe_layout_info.pSetLayouts = vk_desc_layout;
				r = vkCreatePipelineLayout(vk_device, &pipe_layout_info, NULL, &vk_pipeline_layout);
				F3D_ASSERT_VK(r, VK_SUCCESS, "Program_0001_0000_0001_0006 Create pipeline layout failed");
			}

			bool							Program_0001_0000_0001_0006::drawToCommandBuffer(VkCommandBuffer& cmd, f3d::tree::Mesh& mesh, f3d::tree::Scene& scene)
			{
				...
				VkDescriptorSet				sets[4] = { cam.getDescriptorSet() , m.getDescriptorSet(),  material->getDescriptorSet(), texture->getDescriptorSet() };
