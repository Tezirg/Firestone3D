...
namespace f3d {
	...
	typedef enum					eShadingType {
		...
		F3D_SHADING_END_RANGE = F3D_SHADING_SPECULAR_RESERVED_2,
		F3D_SHADING_RANGE_SIZE = (F3D_SHADING_END_RANGE - F3D_SHADING_BEGIN_RANGE + 1),
		F3D_SHADING_MAX_ENUM = 0xFFFFFFFF
	}								eShadingTypeBits;
