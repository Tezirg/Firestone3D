...
namespace f3d {
	...
	typedef F3D_Flags		LightTypeFlags;
	 ...
	 /*
	typedef enum			eShadingDiffuseType {
		F3D_SHADING_DIFFUSE_UNDEFINED = 0x0,
		F3D_SHADING_DIFFUSE_FLAT = 0x1,
		F3D_SHADING_DIFFUSE_GOURAUD = 0x2,
		F3D_SHADING_DIFFUSE_LAMBERT = 0x4,
		F3D_SHADING_DIFFUSE_ORENNAYAR = 0x8,
		F3D_SHADING_DIFFUSE_TOON = 0x10,
		F3D_SHADING_DIFFUSE_BEGIN_RANGE = F3D_SHADING_DIFFUSE_UNDEFINED,
		F3D_SHADING_DIFFUSE_END_RANGE = (F3D_SHADING_DIFFUSE_GAUSSIAN - F3D_SHADING_DIFFUSE_UNDEFINED + 1),
		F3D_SHADING_DIFFUSE_MAX_ENUM = 0x7FFFFFFF
	}						eShadingDiffuseTypeBits;

	typedef enum			eShadingSpecularType {
		F3D_SHADING_SPECULAR_UNDEFINED = 0x0,
		...
		F3D_SHADING_SPECULAR_BEGIN_RANGE = F3D_SHADING_SPECULAR_UNDEFINED,
		F3D_SHADING_SPECULAR_END_RANGE = (F3D_SHADING_SPECULAR_GAUSSIAN - F3D_SHADING_SPECULAR_UNDEFINED + 1),
		F3D_SHADING_SPECULAR_MAX_ENUM = 0x7FFFFFFF
	}						eShadingSpecularTypeBits;
	// */
	typedef enum			eShadingType {
		...
		F3D_SHADING_ORENNAYAR = 0x10,
		F3D_SHADING_MINNAERT = 0x20,
		F3D_SHADING_COOKTORRANCE = 0x40,
		F3D_SHADING_CUSTOM = 0x80,
